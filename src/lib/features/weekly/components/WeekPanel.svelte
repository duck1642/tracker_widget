...
<style>
  .week-panel { --panel-bottom-gap: 22px; display: grid; align-content: start; gap: 16px; width: 100%; margin: 0 auto; padding: 0 16px var(--panel-bottom-gap); box-sizing: border-box; }
