...
<main class="week-panel">
  ...
  {:else}
    <header class="week-hero"><div><span class="eyebrow">Planning ledger</span><h1>{weekStore.descriptor.year} · Week {weekStore.descriptor.week}</h1><p>{weekStore.descriptor.rangeLabel}</p></div><nav aria-label="Week sections"><a href="#objectives">Objectives</a><a href="#plan">Plan</a><a href="#actual">Actual</a><a href="#week-notes">Notes</a></nav></header>
