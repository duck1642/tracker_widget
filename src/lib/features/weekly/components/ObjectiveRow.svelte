...
<style>
  article { display: grid; grid-template-columns: minmax(140px, .8fr) 115px 115px minmax(220px, 1.4fr) 32px; align-items: end; gap: 9px; padding: 10px 0; border-bottom: 1px solid var(--border-subtle); }
  ...
  @media (max-width: 820px) { article { grid-template-columns: 1fr 1fr 1fr 32px; } .description { grid-column: 1 / -1; grid-row: 2; } }
</style>
