...
<style>
  header { position: sticky; top: 0; z-index: 70; display: flex; align-items: end; justify-content: space-between; gap: 20px; padding: 22px 0 14px; background: var(--bg-panel); }
